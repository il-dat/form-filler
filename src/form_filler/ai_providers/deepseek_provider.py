#!/usr/bin/env python3
"""
DeepSeek Provider implementation for form-filler.

Provides integration with DeepSeek API for LLM inference.
"""
...
class DeepseekProvider(AIProvider):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            api_base: Base URL for DeepSeek API (default: https://api.deepseek.com/v1)
        ...
        self._is_vision_model = "vision" in model_name.lower()
    ...
    def initialize(self) -> None:
        ...
        try:
            ...
            if response.status_code != 200:
                raise ValueError(f"DeepSeek API returned status code {response.status_code}")

            logger.debug(f"Successfully connected to DeepSeek API using model: {self.model_name}")
    ...
    def text_completion(
        ...
        """
        # For DeepSeek, we use the chat completion API for text completions
        messages = []
    ...
    def vision_completion(
        ...
        """Generate a completion based on an image using DeepSeek.
        ...
        if not self.supports_vision:
            raise ValueError(
                f"DeepSeek model '{self.model_name}' does not support vision. "
        ...
        try:
            ...
            logger.error(f"DeepSeek vision completion failed: {e}")
            raise

    @property
    def supports_vision(self) -> bool:
        """Check if this DeepSeek model supports vision capabilities.
    ...
    def supports_streaming(self) -> bool:
        ...
        Returns:
            True as DeepSeek supports streaming
        """
        return True
    ...
    def requires_api_key(self) -> bool:
        ...
        Returns:
            True as DeepSeek requires API keys
        """
        return True
